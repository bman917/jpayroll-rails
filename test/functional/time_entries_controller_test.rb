...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { employee_id: @time_entry.employee_id, hours: @time_entry.hours, time_in: @time_entry.time_in, time_out: @time_entry.time_out }
    end
  ...
  test "should update time_entry" do
    put :update, id: @time_entry, time_entry: { employee_id: @time_entry.employee_id, hours: @time_entry.hours, time_in: @time_entry.time_in, time_out: @time_entry.time_out }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
